...
class Section(models.Model):
    ...
    def __str__(self):
         return f"{self.course, self.professor.first_name, self.professor.last_name}"
    #def __str__(self):
        #return self.crn
        #return f"{self.crn}"
...
class Syllabus(models.Model):
    ...
    #course_id = models.CharField('Course', default= 'name', max_length=50)
    ...
    def __str__(self):
        return  f"Syllabus for {self.section_id}"
        #return f"{self.crn}"
...
class Feedback(models.Model):
    ...
    def __str__(self):
        return f"Feedback for {self.section_id}"
    #def __str__(self):
